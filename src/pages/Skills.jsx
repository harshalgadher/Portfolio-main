        ...
        <>
            <div className="bg-[#111827] text-white py-16 px-4 min-h-screen">
                <div className="max-w-7xl mx-auto">
                    <div>
                        <h1 className="text-4xl font-bold text-center mb-4">Skills & <span className="text-purple-400">Expertise</span></h1>
                    </div>
                    <div>
                        <p className="text-gray-300 text-center font-semibold max-w-2xl mx-auto mb-12">Here's a quick overview of my skill include frontend magic , backend wizardry, and everything in between. I am always eager to learn new technologies</p>
                    </div>
