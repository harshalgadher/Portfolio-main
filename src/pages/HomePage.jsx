            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
                <div className="row flex">
                    <div className="w-8/12">
                        ...
                        <div class="my-6 font-semibold p-4 border-l-4 border-purple-400 ">
                            <p class="italic text-blue-200">A Student Fueled By Curiosity , Innovative Ideas And Continuous Learning, Figuring Out Stuff !!</p>
                        </div>
